...
export default function AdminLayout({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="flex h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
            {/* Sidebar */}
            <div className="w-64 bg-black bg-opacity-40 border-r border-gray-800">
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                {/* Üst çubuk */}
                <header className="flex h-16 items-center justify-between border-b border-gray-800 bg-black bg-opacity-30 px-6">
                ...
                {/* İçerik */}
                <main className="flex-1 overflow-y-auto p-6 bg-gray-900 bg-opacity-60">
                    {children}
                </main>
            </div>
        </div>
