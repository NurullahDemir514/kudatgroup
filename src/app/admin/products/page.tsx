    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-300 via-white to-gray-400">Ürün Listesi</h1>
                <button
                        ...
                        <form onSubmit={handleSubmitForm}>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex flex-col space-y-2">
                                    {imagePreview ? (
                                        <div className="relative mb-2 h-40 w-full overflow-hidden rounded-md border border-gray-700">
                                            <img
                                                src={imagePreview}
                                        ...
                                        <div className="flex items-center justify-center">
                                            <label className="flex h-32 w-full cursor-pointer flex-col items-center justify-center rounded-md border border-dashed border-gray-700 bg-black bg-opacity-40 hover:border-silver">
                                                {imageUploading ? (
                                                    <div className="flex flex-col items-center justify-center space-y-2">
                                                        <div className="h-8 w-8 animate-spin rounded-full border-b-2 border-t-2 border-silver"></div>
                                                    ...
                                                    <>
                                                        ...
                                                        <span className="mt-2 text-sm text-gray-400">Görsel seçmek için tıklayın</span>
                                                    </>
                                                )}
                                                <input
                                                    type="file"
                            ...
                            <div className="mb-4">
                                <label htmlFor="stock" className="mb-1 block text-sm font-medium text-silver">
                                    Stok
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label htmlFor="category" className="mb-1 block text-sm font-medium text-silver">
                                    Kategori
                                </label>
                                <select
                                    id="category"
                            ...
                            {formData.category === "new" && (
                                <div className="mb-4">
                                    <label htmlFor="newCategory" className="mb-1 block text-sm font-medium text-silver">
                                        Yeni Kategori Adı
                                    </label>
                                    <input
                                        type="text"
                            ...
                            <div className="mb-4">
                                <label htmlFor="supplier" className="mb-1 block text-sm font-medium text-silver">
                                    Tedarikçi
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4 grid grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="wholesalePrice" className="mb-1 block text-sm font-medium text-silver">
                                ...
                                <div>
                                    <label htmlFor="salePrice" className="mb-1 block text-sm font-medium text-silver">
                                        Satış Fiyatı (TL)
                                    </label>
                                    <input
                                        type="text"
                            ...
                            <div className="mt-6 flex justify-end space-x-3">
                                ...
                                >
                                    {formSubmitting ? (
                                        <div className="flex items-center space-x-2">
                                            <div className="h-4 w-4 animate-spin rounded-full border-t-2 border-silver"></div>
                                            <span>İşleniyor...</span>
                                        </div>
                                    ) : (
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center">
                                                    {product.image ? (
                                                        ...
                                                        <div className="h-14 w-14 flex-shrink-0 rounded-md border border-gray-700 bg-zinc-800 mr-3 flex items-center justify-center">
                                                    ...
                                                    <div>
                                                        <div className="text-sm font-medium text-silver">{product.name}</div>
                                                        <div className="text-sm text-gray-300">{product.description}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="whitespace-nowrap px-6 py-4">
                                                <div className="rounded-full bg-zinc-800 bg-opacity-70 px-2 py-1 text-xs font-medium text-silver border border-gray-700">
                                                    {product.category}
                                                </div>
                                            </td>
                                            <td className="whitespace-nowrap px-6 py-4">
                                                <div className="text-sm font-medium text-silver">{formatCurrency(product.salePrice)}</div>
                                            </td>
                                            <td className="whitespace-nowrap px-6 py-4">
                                                <div
            ...
            {showImageModal && selectedImage && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90" onClick={closeImageModal}>
                    <div className="relative p-4 md:p-8">
                        <button
                            className="absolute right-4 top-4 rounded-full bg-black bg-opacity-80 p-2 text-white hover:bg-opacity-100"
                        ...
                        <div className="h-[80vh] max-w-[90vw] flex items-center justify-center">
                            <img
                                src={selectedImage}
                                alt="Ürün görseli"
