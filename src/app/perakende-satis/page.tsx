                    ...
                    <div className="max-w-2xl mx-auto px-6">
                        <div className="bg-white/90 backdrop-blur-md rounded-[2rem] p-8 md:p-10 shadow-xl border border-white/50">
                            <div className="text-center mb-8">
                                <div className="inline-flex justify-center items-center w-16 h-16 rounded-[1.2rem] bg-white shadow-lg mb-6">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            />
                                            {errors.firstName && (
                                                <span className="text-xs text-red-500 mt-1 block">{errors.firstName.message?.toString()}</span>
                                            )}
                                        </div>
                                        <div>
                                            ...
                                            />
                                            {errors.lastName && (
                                                <span className="text-xs text-red-500 mt-1 block">{errors.lastName.message?.toString()}</span>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            id="interests"
                                            className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all"
                                            {...register("interests")}
                                        >
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-3 text-sm">
                                            <label htmlFor="marketing" className="text-gray-600 font-light">
